...
imagem_entrada_nome = os.path.join(diretorio_atual, "analise.jpg")
...
if os.path.exists(imagem_entrada_nome):
    try:
        ...
        print(f"Ocorreu um erro ao copiar imagem: {e}")
else:
    print(f"A imagem '{imagem_entrada_nome}' nao foi encontrado na pasta")